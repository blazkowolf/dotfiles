...
local function on_attach(client, bufnr)
	...
	-- vim.keymap.set("n", "<space>rn", "<cmd>Lspsaga rename<CR>", keymap_opts)
	...
	-- vim.keymap.set("n", "<space>e", "<cmd>Lspsaga show_line_diagnostics<CR>", keymap_opts)
	...
	-- vim.keymap.set("n", "<leader>o", "<cmd>LSoutlineToggle<CR>", keymap_opts)
